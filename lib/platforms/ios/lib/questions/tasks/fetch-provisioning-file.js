var Q = require('q'),
    ...
    download = require('../../nomad/provisioning/download'),
    install = require('../../nomad/provisioning/install');
...
module.exports = function (response) {
    if (!response.adhoc_provisioning_profile_name
            && !response.store_provisioning_profile_name
            || response.createProjectFromTarifaFile ) {
